...
public class Asm02 {
    ...
    public static void main(String[] args) {
        ...
        // for testing
        Customer customer1 = new Customer("Luffy", "037199789111");
        bank.addCustomer(customer1);
        Account account1 = new Account("123456", 1000000);
        bank.addAccount("037199789111", account1);

        Customer customer2 = new Customer("Nami", "037199789112");
        bank.addCustomer(customer2);
        Account account2 = new Account("234567", 10000000);
        Account account3 = new Account("345678", 2000000);
        bank.addAccount("037199789112", account2);
        bank.addAccount("037199789112", account3);
