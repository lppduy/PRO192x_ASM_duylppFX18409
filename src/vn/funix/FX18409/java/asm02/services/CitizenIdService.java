...
public class CitizenIdService {  //  This class is for ASM02

    // Constants for citizen ID length and invalid birthplace
    protected static final int CITIZEN_ID_LENGTH = 12;
    protected static final String INVALID_BIRTH_PLACE = "None";

    public String getAndValidateCitizenIdFromUser() {
        Scanner sc = new Scanner(System.in);
        String citizenId;
        do {
            System.out.println("Nhap so CCCD: ");
            citizenId = sc.next();
            if (bank.isCustomerExisted(citizenId)) {
